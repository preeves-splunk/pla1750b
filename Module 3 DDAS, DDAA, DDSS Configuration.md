...
![Splunk Cloud Settings page with Settings and Indexes options highlighted in red](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/1_1.png?raw=true)
...
![Splunk Cloud Indexes Settings page with devops index name, 0GB, 90 days retention, 365 day retention for DDAA, and save button highlighted in red](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/1_3.png?raw=true)

5. If prompted, click the **Continue** button

![Splunk Cloud showing Saving New Index Pane with continue button highlighted in red](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/1_5.png?raw=true)
...
![Splunk Cloud Indexes Settings page Edit link for purchases index highlighted in red](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/2_1.png?raw=true)
...
![Splunk Cloud Indexes Settings page for purchases index with Create a self storage link highlighted in red](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/2_2.png?raw=true)

4. Start creating the new DDSS destination by clicking the **New Self Storage Location** button.

![Splunk Cloud Self Storage Locations page with New Self Storage Location button highlighted in red](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/2_3.png?raw=true)
...
![Splunk Cloud New Self Storage Location Pane with title of ddss-dest, and AWS S3 bucket name of pla1750b-0603-qlfzgg20m0oa-ddss-dest for AWS S3 bucket name highlighted in red](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/2_4.png?raw=true)
...
![Splunk Cloud New Self Storage Location Pane with Generate button for AWS S3 bucket policy highlighted in red, and bucket policy pane highlighted in green](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/2_5.png?raw=true)
...
![Splunk Cloud New Self Storage Location Pane with Test button for Test bucket policy and Submit button highlighted in red, and Success! text highlighted in green](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/2_6.png?raw=true)
...
![Splunk Cloud Indexes Settings page for purchases index with Self Storage option, Please select option dropdown, and pla1750b-0603-qlfzgg20m0oa-ddss-det options, and Save button highlighted in red](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/3_1.png?raw=true)
...
![Splunk Cloud Indexes Settings page with Restore link for aws index highlighted in red](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/4_1.png?raw=true)
...
![Splunk Cloud Restore Archive pane for aws index shown with time range options of 6/4/2023 to 6/17/2023, Check Size and Restore buttons highlighted in red, options from above numbered, and Total Restore size of 1.05GB highlighted in green](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/4_2.png?raw=true)

5. You would then click the **Restore** button on the `Confirmation` pop-up to start the restore process.

![Splunk Cloud Restore Archive Confirmation pop-up for restore job show with Restore button highlighted in red](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/4_3.png?raw=true)
...
![Splunk Cloud Restore Restore Archive pane for aws index shown with restore job information highlighted in green](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/4_4.png?raw=true)


7. After 24 hours the restore job has a status of `Success`:

![Splunk Cloud Restore Restore Archive pane for aws index shown with restore job information with status of Success highlighted in green](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/4_5.png?raw=true)

A screenshot showing a restoration request notification email for a similar DDAA restore job can be seen below:

![Screenshot of a DDAA restoration notification email ](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/4_6.png?raw=true)
...
![Splunk Cloud Restore Restore Archive pane for aws index shown with restore job Clear link highlighted in red ](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/4_8.png?raw=true)
...
![Splunk Cloud Restore Restore Archive pane for aws index shown with restore job Cleared status highlighted in green ](https://github.com/preeves-splunk/pla1750b/blob/v3/assets/module_3/4_9.png?raw=true)
